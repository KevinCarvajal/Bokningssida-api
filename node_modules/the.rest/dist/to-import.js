...
const _ = {
  ...
  Bookning: class Bookning extends RestClient {
    static get route(){
      return '/api/booknings';
    }
    static get array(){
      let _class = this;
      this._arrayClass = this._arrayClass || class BookningArray extends RestClientArray {
        static get _class() {
          return _class;
        }
      }
  ...
  Salong: class Salong extends RestClient {
    static get route(){
      return '/api/salongs';
    }
    static get array(){
      let _class = this;
      this._arrayClass = this._arrayClass || class SalongArray extends RestClientArray {
        static get _class() {
          return _class;
        }
      }
...
export const Bookning = _.Bookning;
export const Salong = _.Salong;
export const User = _.User;
